...
public class TestList {
    ...
    static File templateReport = new File("/opt/sobre5/module/_informes/_informex/common/listas/listas.vsl");
    static File templateSubReport = new File("/opt/sobre5/module/_informes/_informex/common/listas/listas_subreport.vsl");
