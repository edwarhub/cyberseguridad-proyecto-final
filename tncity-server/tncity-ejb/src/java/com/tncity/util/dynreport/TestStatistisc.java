...
public class TestStatistisc {
    ...
    static File templateReport = new File("/opt/sobre5/module/_informes/_informex/common/estadisticas/estadisticas.vsl");
    static File templateSubReport = new File("/opt/sobre5/module/_informes/_informex/common/estadisticas/estadisticas_subreport.vsl");
