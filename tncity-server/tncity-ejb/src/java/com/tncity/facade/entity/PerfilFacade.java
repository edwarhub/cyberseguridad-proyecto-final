...
public class PerfilFacade extends AbstractFacade<Perfil> {
    ...
    public List<PerfilHasUsuario> listUsuariosLight(Integer idperfil) {
        String hql = "SELECT up.idpu,up.idperfil.idperfil,up.idusuario.idusuario,up.idusuario.idpersona.idpersona,up.idusuario.idpersona.numdocumento,up.idusuario.idpersona.nombres,up.idusuario.idpersona.apellidos "
